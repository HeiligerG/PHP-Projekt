...
<aside id="sidebar" class="transform -translate-x-full xl:translate-x-0 w-full xl:w-64 bg-slate-900 border-r border-slate-800 h-screen fixed left-0 top-0 transition-transform duration-300 ease-in-out z-40">
    <div class="flex flex-col h-full">
        <div class="p-6 border-b border-slate-800">
            <a href="/2024/blogs/gianluca" class="flex items-center">
        ...
        <?php else: ?>
            <div class="p-6 border-b border-slate-800">
                <div class="space-y-2">
                    <a href="/2024/blogs/gianluca/login" class="flex items-center justify-center px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition-colors">
                        <span>Anmelden</span>
                    </a>
                    <a href="/2024/blogs/gianluca/register" class="flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
        ...
        <div class="p-4">
            ...
            <div class="space-y-1">
                <a href="/2024/blogs/gianluca/views/profile/"
                ...
                <a href="/2024/blogs/gianluca/profile/change-password"
                   class="flex items-center text-slate-300 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <nav class="flex-1 p-6">
            ...
            <ul class="space-y-1">
                <li>
                    <a href="/2024/blogs/gianluca" class="flex items-center text-slate-300 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="/2024/blogs/gianluca/posts/create" class="flex items-center text-slate-300 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="/2024/blogs/gianluca/posts/my-posts" class="flex items-center text-slate-300 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li class="sm:block md:block lg:block xl:block 2xl:hidden">
                    <a href="/2024/blogs/gianluca/views/bljblogs/blogs.php" class="flex items-center text-slate-300 hover:text-white hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <?php if (isLoggedIn()): ?>
            <div class="p-6 border-t border-slate-800">
                <a href="/2024/blogs/gianluca/logout" class="flex items-center text-red-400 hover:text-red-300 hover:bg-slate-800 px-3 py-2 rounded-lg transition-colors w-full">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
